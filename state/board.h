...
#define WHITE_SHORT_CASTLE_CHECK_MASK 0x0EULL
#define WHITE_LONG_CASTLE_CHECK_MASK 0x38ULL
#define BLACK_SHORT_CASTLE_CHECK_MASK 0x0E00000000000000ULL
#define BLACK_LONG_CASTLE_CHECK_MASK 0x3800000000000000ULL
...
#define MAX_SAVED_GAMESTATES                                                   \
  512 // Max a chess game could need is ~12,000 but 99% will be less than 512
