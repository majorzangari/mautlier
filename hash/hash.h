...
#define ZOBRIST_BLACK_PAWN 1
#define ZOBRIST_WHITE_KNIGHT 2
#define ZOBRIST_BLACK_KNIGHT 3
#define ZOBRIST_WHITE_BISHOP 4
#define ZOBRIST_BLACK_BISHOP 5
#define ZOBRIST_WHITE_ROOK 6
#define ZOBRIST_BLACK_ROOK 7
#define ZOBRIST_WHITE_QUEEN 8
#define ZOBRIST_BLACK_QUEEN 9
#define ZOBRIST_WHITE_KING 10
